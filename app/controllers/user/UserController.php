...
class UserController extends BaseController {
    ...
    {   
        ...
        $messages = array(
            'required' => 'Required',
            'email' => 'Invaild Email',
            'numeric' => 'Invaild!!! Should be numeric only',
        );
        ...
        if ($validator->passes())
        {
           ...
           // $error = $user->errors()->all(':message');
            ...
            // return Redirect::to('admin/collectors/create')->withInput()->withErrors($validator);
        }
     ...
     public function getChange($user)
    {
        ...
        return View::make('site/user/change', compact('user', 'title'));
    }
     ...
     *
     */
    public function postChange($user)
    {
        ...
        return Redirect::to('user/'.$user->id.'/change')->withErrors($validator);
