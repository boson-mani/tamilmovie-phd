...
<html lang="en">
	...
	<body>
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    ...
                    <ul class="nav navbar-nav pull-right">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="{{{ URL::to('user/'.Auth::user()->id.'/change') }}}"><span class="glyphicon glyphicon-cog"></span> Change Password</a></li>
						</ul>
						</li>
	    ...
	    <div id="footer" style="border-top:1px solid #ccc;padding-top: 10px;margin-top: 10px;">
	      <div class="container">
	        <p class="muted credit">&copy; <?php echo date('Y');?>.</p>
	      </div>
	    </div>
